...
/* paths are as follows:
 ...
 special://Plex/          - the main Plex folder (i.e. where the app resides).
 special://home/          - a writeable version of the main Plex folder
                             Linux: ~/.xbmc/
                             OS X:  ~/Library/Application Support/Plex/
                             Win32: ~/Application Data/Plex/
 ...
 special://masterprofile/ - the master users userdata folder - usually special://home/userdata
                             Linux: ~/.xbmc/userdata/
                             OS X:  ~/Library/Application Support/Plex/UserData/
                             Win32: ~/Application Data/Plex/UserData/
 special://profile/       - the current users userdata folder - usually special://masterprofile/profiles/<current_profile>
                             ...
                             OS X:  ~/Library/Application Support/Plex/UserData/profiles/<current_profile>
                             Win32: ~/Application Data/Plex/UserData/profiles/<current_profile>

 special://temp/          - the temporary directory.
                             Linux: ~/tmp/xbmc<username>
                             OS X:  ~/
                             Win32: ~/Application Data/Plex/cache
*/
